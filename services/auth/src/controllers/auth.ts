...
type Role = "customer" | "Rider" | "Seller"; // adjust to match your schema

const allowedRoles: Role[] = ["customer", "Rider", "Seller"];

/* =========================================
   SIGNUP
========================================= */

export const signupUser = TryCatch(async (req: Request, res: Response) => {
